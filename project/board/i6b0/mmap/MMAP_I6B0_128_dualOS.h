...
/* E_LX_MEM_APP   */
#define E_LX_MEM_APP_LAYER                                     0
#define E_LX_MEM_APP_AVAILABLE                                 0x0004000000
#define E_LX_MEM_APP_ADR                                       0x0004000000  //Alignment 0x01000
#define E_LX_MEM_APP_GAP_CHK                                   0x0000000000
#define E_LX_MEM_APP_LEN                                       0x0000000000
#define E_LX_MEM_APP_MEMORY_TYPE                               (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_LX_MEM_APP_CMA_HID                                   0

/* E_MMAP_ID_RTK_mma_heap   */
#define E_MMAP_ID_RTK_mma_heap_LAYER                           0
#define E_MMAP_ID_RTK_mma_heap_AVAILABLE                       0x0004000000
#define E_MMAP_ID_RTK_mma_heap_ADR                             0x0004000000  //Alignment 0x01000
#define E_MMAP_ID_RTK_mma_heap_GAP_CHK                         0x0000000000
#define E_MMAP_ID_RTK_mma_heap_LEN                             0x0002000000
#define E_MMAP_ID_RTK_mma_heap_MEMORY_TYPE                     (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_MMAP_ID_RTK_mma_heap_CMA_HID                         0

/* E_MMAP_ID_RTK   */
#define E_MMAP_ID_RTK_LAYER                                    0
#define E_MMAP_ID_RTK_AVAILABLE                                0x0006000000
#define E_MMAP_ID_RTK_ADR                                      0x0006000000  //Alignment 0x01000
#define E_MMAP_ID_RTK_GAP_CHK                                  0x0000000000
#define E_MMAP_ID_RTK_LEN                                      0x0002000000
#define E_MMAP_ID_RTK_MEMORY_TYPE                              (MIU0 | TYPE_NONE | UNCACHE | TYPE_NONE)
#define E_MMAP_ID_RTK_CMA_HID                                  0
