...
int main(int argc, char *argv[])
{
    ...
    out_record("KERNEL",    (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00050000, 0x00180000, MXP_PART_STATUS_EMPTY, i++);
    out_record("rootfs",    (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x001D0000, 0x002E0000, MXP_PART_STATUS_EMPTY, i++);
    out_record("nvrservice",(MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x004B0000, 0x00180000, MXP_PART_STATUS_EMPTY, i++);
    out_record("customer",  (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00630000, 0x001C0000, MXP_PART_STATUS_EMPTY, i++);
    out_record("private",   (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x007F0000, 0x00010000, MXP_PART_STATUS_EMPTY, i++);
