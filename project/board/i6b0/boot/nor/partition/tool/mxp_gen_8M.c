...
int main(int argc, char *argv[])
{
    ...
    out_record("miservice",(MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD) ,   0x00460000, 0x001B0000, MXP_PART_STATUS_EMPTY, i++);
    out_record("customer",  (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00610000, 0x001E0000, MXP_PART_STATUS_EMPTY, i++);
