...
int main(int argc, char *argv[])
{
    ...
    out_record("rootfs",    (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x001D0000, 0x00290000, MXP_PART_STATUS_EMPTY, i++);
    out_record("miservice",(MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD) ,   0x00460000, 0x001A0000, MXP_PART_STATUS_EMPTY, i++);
    out_record("customer",  (MXP_PART_TYPE_NORMAL|MXP_PART_TYPE_MTD),   0x00600000, 0x001F0000, MXP_PART_STATUS_EMPTY, i++);
