...
CAMCLK_RET_e HalCamClkGetVenpllRoundRate(void *pCfg)
{
    ...
    if(pVenpllCfg->u32Rate <= 300000000)
    {
        pVenpllCfg->u32RoundRate = 300000000;
    }
    else if(pVenpllCfg->u32Rate <= 312000000)
    {
        pVenpllCfg->u32RoundRate =  312000000;
    }
    else if(pVenpllCfg->u32Rate <= 324000000)
    {
        pVenpllCfg->u32RoundRate =  324000000;
    }
    else if(pVenpllCfg->u32Rate <= 336000000)
    {
        pVenpllCfg->u32RoundRate =  336000000;
    }
    else if(pVenpllCfg->u32Rate <= 348000000)
    {
        pVenpllCfg->u32RoundRate =  348000000;
    }
    else{
        pVenpllCfg->u32RoundRate =  348000000;
    }
...
CAMCLK_RET_e HalCamClkSetVenpllRate(void *pCfg)
{
    ...
    if (    (pVenpllCfg->u32Rate == 348000000) ||
            (pVenpllCfg->u32Rate == 336000000) ||
            (pVenpllCfg->u32Rate == 324000000) ||
            (pVenpllCfg->u32Rate == 312000000) ||
...
HalCamClkAdjOps_t gVenOps={0,0,HalCamClkSetVenpllRate,HalCamClkGetVenpllRate,HalCamClkGetVenpllRoundRate,HalCamClkSetVenpllOnOff,HalCamClkGetVenpllOnOff};
