...
#endif
#if ENABLE_NBLK_CALL
struct semaphore        _interos_nblk_call_req;
...
void do_interos_nblk_call(u32 type, u32 arg1, u32 arg2, u32 arg3)
{
}
...
static int interos_nblk_call_receiver(void *unused)
{
    ...
    sema_init(&_interos_nblk_call_req, 0);
    while (1) {
        ...
        do {
            ...
            /* process here */
            do_interos_nblk_call(arg0, arg1, arg2, arg3);
	    } while (1);
	}
	return 0;
}
...
static int __init epoch_init(void)
{
    ...
    sema_init(&(_reroute_smc_info.mbox_sem), 1);
    sema_init(&(_reroute_smc_info.resp_sem), 0);
#endif
