...
AACAudioLiveServerMediaSubsession::createNew(UsageEnvironment& env, CONTEXT* ctxt, Boolean reuseFirstSource) {
  return new AACAudioLiveServerMediaSubsession(env, ctxt, reuseFirstSource);
}
...
::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate) {
  AACLiveFramedSource *source = AACLiveFramedSource::createNew(envir(), mContext, mContext->aac_config);
  return source;
}
