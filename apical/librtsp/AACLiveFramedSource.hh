...
public:
  static AACLiveFramedSource* createNew(UsageEnvironment& env, CONTEXT* ctxt, unsigned char* aacconfig);
...
protected:
  AACLiveFramedSource(UsageEnvironment& env, CONTEXT* ctxt, unsigned char* aacconfig);
