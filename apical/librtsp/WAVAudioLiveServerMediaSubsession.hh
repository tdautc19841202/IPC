...
public:
  static WAVAudioLiveServerMediaSubsession* createNew(UsageEnvironment& env, CONTEXT* ctxt, Boolean reuseFirstSource);

protected:
  WAVAudioLiveServerMediaSubsession(UsageEnvironment& env, CONTEXT* ctxt, Boolean reuseFirstSource);
