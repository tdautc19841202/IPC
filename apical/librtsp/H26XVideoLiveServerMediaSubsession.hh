...
public:
  static H26XVideoLiveServerMediaSubsession* createNew(UsageEnvironment& env, CONTEXT* ctxt, Boolean reuseFirstSource);
...
protected:
  H26XVideoLiveServerMediaSubsession(UsageEnvironment& env, CONTEXT* ctxt, Boolean reuseFirstSource);
