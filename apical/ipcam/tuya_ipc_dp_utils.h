...
#define TUYA_DP_DEVICE_RESTART             162         /*device reboot*/
...
#define TUYA_DP_LIGHT_SENSITIVITY          152         /* 设置灯板的PIR灵敏度对应云动的D2D模式,这个灵敏度可应用于自动模式*/
#define TUYA_DP_LIGHT_BRIGHTNESS           158         /* 设置灯板亮度,对应云动的手动模式,也可以将这个亮度应用于定时模式以及D2D模式*/
#define TUYA_DP_LIGHT_PIR_SWITCH           172         /* PIR检测开关,对应云动的自动模式*/
#define TUYA_DP_LIGHT_PIR_TIME             173         /* 设置PIR检测的亮灯时间,对应于云动的自动模式 */
