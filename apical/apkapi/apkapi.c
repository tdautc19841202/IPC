...
int get_wlan_map_and_compare(void)
{
    ...
    int    j = 0;
    int result = 0;
    int  line[6] = {0x00, 0x10, 0xB0, 0xC0, 0xE0, 0x130};
    char *str[6] = {"wlan0    efuse_get:0x29 0x81 0x00 0xCC 0x0B 0x00 0x00 0x00 0x00 0x0C 0x04 0x4C 0x10 0x0C 0x00 0x00",
