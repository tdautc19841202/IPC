...
MI_S32 main(int argc, char **argv)
{
    ...
    while(1)
    {
        ...
        else if((cmd == 'd') || (cmd == 'D') || (cmd == 'H') || (cmd == 'r'))
        {
           ...
           u32BufSizeSrc = timage_resolution.u32image_width * timage_resolution.u32image_height * u32Num / u32Den;

           printf("res(%u*%u), buffersize %u\n", timage_resolution.u32image_width, timage_resolution.u32image_height, u32BufSizeSrc);
            ...
            do
            {
                ...
                //Save image file.
                {
                    ...
                    if(eNode == eRawStoreNode_ISPOUT)
                        sprintf(filename, "dump_ispout_yuv444.raw");
