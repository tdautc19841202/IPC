...
UINT_T max_p2p_num = 3;
VOID *thread_p2p_init(VOID *arg)
{
    ...
    p2p_var.max_client_num = max_p2p_num;
...
#ifdef __HuaweiLite__
    max_p2p_num = max_users;
    TSK_INIT_PARAM_S stappTask;
    int taskid = -1;
    memset(&stappTask, 0, sizeof(TSK_INIT_PARAM_S));
    stappTask.pfnTaskEntry = (TSK_ENTRY_FUNC)thread_p2p_init;
    stappTask.uwStackSize  = 0x100000;
    stappTask.pcName = "p2p_init";
